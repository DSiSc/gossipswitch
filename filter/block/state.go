...
func NewStateTransition(evm *evmNg.EVM, trx *types.Transaction, gp *GasPool) *StateTransition {
...
func ApplyTransaction(evm *evmNg.EVM, tx *types.Transaction, gp *GasPool) ([]byte, uint64, bool, error) {
