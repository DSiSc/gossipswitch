...
help:
	@echo 'Management commands for DSiSc/gossipswitch:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building gossipswitch ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/gossipswitch/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/gossipswitch/version.BuildDate=${BUILD_DATE}" ./...
